...
.form-div
{
  ...
  <body> 
      ...
      <div class="form-div">
      <form action="cashinprocess.php" method="POST">
      <!-- <input type="button"  value="Profile" onclick="profilefn();"> -->
      <h1 class="title">Cash In </h1>
       <br>

      <input class="form-control" type="number" id="amount" name="amount" placeholder="Enter Amount number" required >
      
      <br>
      <input class="form-control" type="text" id="ac" name="ac" placeholder="Enter your bank account number" required >
      <br>
      <input class="form-control" type="text" id="holder" name="holder" placeholder="Enter your bank account holder name" required>
      <br>
      <input class="form-control" type="password" id="upass2" name="upass2" placeholder="Enter your Bank account password" required>
      <br>
